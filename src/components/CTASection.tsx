  ...
  return (
    <section className="py-20 md:py-32 bg-hero-gradient relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-20 left-20 w-40 h-40 bg-accent/10 blob animate-float" />
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-yellow/10 blob-alt animate-float-delayed" />
